...
export const liveClassApi = {
  ...
  end: (id: string) => api.post<EndLiveResult>(`/live-classes/${id}/end`).then(res => res.data),
};
...
export const attendanceApi = {
  ...
  getWindow: (liveClassId: string) =>
    api.get<CheckInWindow>(`/attendance/live-class/${liveClassId}/window`).then(res => res.data),
